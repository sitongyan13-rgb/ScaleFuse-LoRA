_base_ = './odinw_pothole_static_scale_aware_lora_r16.py'
...
train_cfg = dict(_delete_=True, type='IterBasedTrainLoop', max_iters=100,
                 val_interval=100)
param_scheduler = [
...
work_dir = 'experiments/odinw_pothole_static_scale_aware_lora_r16_smoke'
